...
The chosen metric for intrinsic evaluation was SSIM (Structural Similarity Index Measure) \cite{TODO}. 
...
The results are overwhelmingly positive, with the GARD dataset consistently
matching or outperforming the LARD dataset in most cases. Especially in the
